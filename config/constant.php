...
return [
    ...
    'OTP_MIN' => 1000,
    'OTP_MAX' => 9999,
    'MICROSECOND_TO_SECOND' => 1000,
    'HOUR_TO_SECOND' => 3600,
    'DEVICE_LIMIT' => 1,
    'MIN_HOURS_TO_SHOW_DIFF' => 25,
    ...
    'MODULES' => [
        ...
        [
            'module_name' => 'Setting',
            'more_permission' => ['bussiness', 'misc', 'custom_code', 'customization', 'mail', 'notification', 'intigrations',  'language', 'invoice','module', 'app_Setting'],
            'is_custom_permission' => 0,
        ],
