...
return [
    'app' => [
        ...
        'elements' => [
            ...
            [
                ...
                'rules' => 'nullable|url|max:191', // validation rule of laravel
                'class' => '', // any class for input
            ...
            [
                ...
                'rules' => 'nullable|url|max:191', // validation rule of laravel  max:191   url
                'class' => '', // any class for input
    ...
    'video_player' => [
        'title' => 'Lecteur Vidéo',
        'desc'  => 'Paramètres du lecteur vidéo de la plateforme.',
        ...
        'elements' => [
            [
                ...
                'class'    => '',
                'value'    => '0',
                'help'     => 'Démarrer automatiquement la lecture au chargement du contenu.',
            ],
            [
                'type'     => 'checkbox',
                'data'     => 'video_player',
                'name'     => 'player_muted_on_load',
                'label'    => 'Muet au chargement',
                'rules'    => 'boolean',
                'class'    => '',
                'value'    => '0',
            ...
            [
                'type'     => 'checkbox',
                'data'     => 'video_player',
                'name'     => 'player_skip_intro',
                'label'    => 'Bouton Skip Intro',
                'rules'    => 'boolean',
                'class'    => '',
                'value'    => '1',
            ...
            [
                'type'     => 'number',
                'data'     => 'video_player',
                'name'     => 'player_skip_intro_delay',
                'label'    => 'Délai avant Skip Intro (secondes)',
                'rules'    => 'nullable|integer|min:0|max:300',
                'class'    => '',
                'value'    => '5',
                'help'     => 'Nombre de secondes après lesquelles le bouton Skip Intro apparaît.',
            ],
            [
                'type'     => 'select',
                'data'     => 'video_player',
                'name'     => 'player_default_quality',
                'label'    => 'Qualité par défaut',
                'rules'    => 'nullable|string',
                'class'    => '',
                'value'    => 'auto',
                'help'     => 'Qualité de lecture sélectionnée par défaut.',
            ],
            [
                'type'     => 'checkbox',
                'data'     => 'video_player',
                'name'     => 'player_speed_control',
                'label'    => 'Contrôle de vitesse',
                'rules'    => 'boolean',
                'class'    => '',
                'value'    => '1',
            ...
            [
                'type'     => 'checkbox',
                'data'     => 'video_player',
                'name'     => 'player_download_enabled',
                'label'    => 'Téléchargement activé',
                'rules'    => 'boolean',
                'class'    => '',
                'value'    => '0',
            ...
            [
                'type'     => 'checkbox',
                'data'     => 'video_player',
                'name'     => 'player_subtitles_default',
                'label'    => 'Sous-titres activés par défaut',
                'rules'    => 'boolean',
                'class'    => '',
                'value'    => '0',
            ...
            [
                'type'     => 'select',
                'data'     => 'video_player',
                'name'     => 'player_watermark_position',
                'label'    => 'Position du filigrane',
                'rules'    => 'nullable|string',
                'class'    => '',
                'value'    => 'top-right',
                'help'     => 'Position du filigrane de la plateforme affiché sur le lecteur.',
            ],
            [
                'type'     => 'select',
                'data'     => 'video_player',
                'name'     => 'ppv_watermark_enabled',
                'label'    => 'Filigrane utilisateur (PPV)',
                'rules'    => 'boolean',
                'class'    => '',
                'value'    => '1',
            ...
            [
                'type'     => 'select',
                'data'     => 'video_player',
                'name'     => 'ppv_watermark_content',
                'label'    => 'Contenu du filigrane PPV',
                'rules'    => 'nullable|string',
                'class'    => '',
                'value'    => 'name_email',
                'help'     => 'Informations affichées dans le filigrane utilisateur.',
            ],
            [
                'type'     => 'number',
                'data'     => 'video_player',
                'name'     => 'ppv_watermark_opacity',
                'label'    => 'Opacité du filigrane PPV (0-100)',
                'rules'    => 'nullable|integer|min:5|max:100',
                'class'    => '',
                'value'    => '20',
                'help'     => 'Opacité du filigrane (20 = discret, 60 = visible).',
            ],
            [
                'type'     => 'number',
                'data'     => 'video_player',
                'name'     => 'ppv_watermark_interval',
                'label'    => 'Intervalle déplacement filigrane (secondes)',
                'rules'    => 'nullable|integer|min:5|max:120',
                'class'    => '',
                'value'    => '15',
                'help'     => 'Fréquence de déplacement aléatoire du filigrane.',
            ],
            [
                'type'     => 'number',
                'data'     => 'video_player',
                'name'     => 'player_forward_seconds',
                'label'    => 'Avance rapide (secondes)',
                'rules'    => 'nullable|integer|min:5|max:120',
                'class'    => '',
                'value'    => '10',
    ...
    'elements' => [
        ...
        [
            ...
            'name'     => 'cf_stream_enabled',
            'label'    => 'Enable Cloudflare Stream',
        ...
        [
            'type'     => 'text',
            'data'     => 'storage_settings',
            'name'     => 'cf_stream_customer_subdomain',
            'label'    => 'Cloudflare Customer Subdomain',
            'rules'    => 'nullable|string|max:255',
            'class'    => '',
            'value'    => '',
            'datatype' => 'storageconfig',
        ...
        [
            'type'     => 'text',
            'data'     => 'storage_settings',
            'name'     => 'cf_stream_max_duration',
            'label'    => 'Cloudflare Max Duration Seconds',
