...
class ModuleController extends Controller
{
    ...
    public function index_data(Datatables $datatable, Request $request)
    {
        ...
        $datatable = $datatable->eloquent($query)
            ...
            ->editColumn('updated_at', function ($data) {
                ...
                if ($diff < config('constant.MIN_HOURS_TO_SHOW_DIFF',25)) {
    ...
    public function store(Request $request)
    {
        ...
        $message = __('messages.create_form_module', ['form' => __($this->module_title)]);
    ...
    public function update(Request $request, $id)
    {
        ...
        $message = __('messages.update_form_module', ['form' => __($this->module_title)]);
    ...
    public function destroy($id)
    {
        ...
        $message = __('messages.delete_form_module', ['form' => __($this->module_title)]);
