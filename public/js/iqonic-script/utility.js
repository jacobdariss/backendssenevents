...
(function () {
    ...
    this.IQUtils.getColorShadeTint = (color, value) => {
        ...
        let colors = {
            ...
            [`${color}-shade-80`]: IQUtils.shadeColor(value, 80),
            [`${color}-shade-60`]: IQUtils.shadeColor(value, 60),
            [`${color}-shade-40`]: IQUtils.shadeColor(value, 40),
            [`${color}-shade-20`]: IQUtils.shadeColor(value, 20),
            [`${color}-shade-10`]: IQUtils.shadeColor(value, 10),

            [`${color}-tint-10`]: IQUtils.tintColor(value, 10),
            [`${color}-tint-20`]: IQUtils.tintColor(value, 20),
            [`${color}-tint-40`]: IQUtils.tintColor(value, 40),
            [`${color}-tint-60`]: IQUtils.tintColor(value, 60),
            [`${color}-tint-80`]: IQUtils.tintColor(value, 80),
            [`${color}-tint-90`]: IQUtils.tintColor(value, 90),
    ...
    this.IQUtils.getVariableColor = () => {
        ...
        const color5 = getComputedStyle(document.body).getPropertyValue(`--${prefix}success`);
