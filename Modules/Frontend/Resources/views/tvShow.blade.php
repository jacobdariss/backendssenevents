                                                ...
                                                <div class="movie-info">
                                                        ...
                                                        @if (!empty($slider['duration']))
                                                            <li>
                                                                <span class="d-flex align-items-center gap-2">
                                                                    ...
                                                                    <span class="fw-medium">{{ str_replace(':', 'h ', $slider['duration']) . 'm' }}</span>
                                                                </span>
                                                            </li>
                                                        @endif
                                                    ...
                                                    <div class="mt-5 mb-md-0 mb-3">
                                                        <div
                                                            ...
                                                            <x-watchlist-button :entertainment-id="$slider['id'] ?? null" :in-watchlist="$slider['is_watch_list'] ?? null"
                                                                ...
                                                                <div class="share-wrapper">
                                                                    <div class="share-box dropdown-menu">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <a href="https://twitter.com/intent/tweet?text={{ urlencode($slider['name']) }}&url={{ urlencode(Request::url()) }}"
                                                                                target="_blank" rel="noopener noreferrer"
                                                                                class="share-ico">
                                                                            ...
                                                                            <a href="#" data-link="{{ route('tvshow-details', ['id' => $slider['slug']]) }}"
