<div class="streamit-block">
    ...
    <div class="card-style-slider {{ count($data) <= 6 ? 'slide-data-less' : '' }}">
        <div class="slick-general slick-general-season-pay-per-view" data-items="5" data-items-desktop="4.5" data-items-laptop="4" data-items-tab="3" data-items-mobile-sm="2.5"
