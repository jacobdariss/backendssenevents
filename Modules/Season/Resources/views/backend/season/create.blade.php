                        ...
                        <div class="flex-grow-1 w-100">
                            <div class="row gy-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <span class="text-danger position-absolute w-100 top-100 start-0" id="season_id_error"></span>
                                </div>
                            </div>
                        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row gy-3">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="mb-3">
                                {{ html()->label(__('movie.lbl_name') . ' <span class="text-danger">*</span>', 'name')->class('form-label form-label') }}
                            ...
                            <div class="d-none" id="url_input">
                                {{ html()->label(__('movie.lbl_trailer_url') . ' <span class="text-danger">*</span>', 'trailer_url')->class('form-label form-label') }}
                            ...
                            <div class="d-none" id="embed_input">
                                {{ html()->label(__('movie.lbl_embed_code') . ' <span class="text-danger">*</span>', 'trailer_embedded')->class('form-label form-label') }}
                            ...
                            <div class="d-none" id="url_file_input">
                                {{ html()->label(__('movie.lbl_trailer_video') . ' <span class="text-danger">*</span>', 'trailer_video')->class('form-label form-label') }}
                        ...
                        {{-- <div class="col-md-6 col-lg-4">
                            {{ html()->label(__('movie.lbl_movie_access'), 'access')->class('form-label form-label') }}
                        ...
                        <div class="col-md-6 col-lg-4">
                            ...
                            {{ html()->number('season_number', old('season_number'))->class('form-control')->placeholder(__('season.lbl_season_number_placeholder'))->attribute('required', 'required')->attribute('min', '1') }}
                            @error('season_number')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
    ...
    <script>
            ...
            setup: function(editor) {
                const syncDescriptionErrors = function() {
                    ...
                    if (!textContent) { /* only show after form submit */ } else {
                        ...
                        try {
                            const errs = window.__seasonCreateCurrentErrors || {};
                            ...
                            window.__seasonCreateCurrentErrors = errs;
                            if (window.showErrorCountOnTabs && window.__seasonCreateTabFields) { window.showErrorCountOnTabs(errs, window.__seasonCreateTabFields); }
                        } catch (e) {}
                    }
                };
        ...
        $(document).ready(function() {
            ...
            // Clear validation errors on selection
             $('#season_id').on('change select2:select', function() {
                if ($(this).val()) {
                    $('#season_id_error').text('');
                }
            });
             $('#tv_show_id').on('change select2:select', function() {
                if ($(this).val()) {
        ...
        const seasonTabFields = {
            'pills-movie': ['name', 'season_number', 'description', 'short_desc', 'entertainment_id', 'trailer_url_type', 'trailer_url',
        ...
        let currentErrors = {};
        window.__seasonCreateCurrentErrors = currentErrors;
        window.__seasonCreateTabFields = seasonTabFields;
        ...
        document.getElementById('form-submit').addEventListener('submit', function(e) {
            ...
            // Trailer URL: when type needs URL, validate empty and format on submit
        ...
        function clearFieldValidation(el) {
            ...
            var errId = fieldKey === 'trailer_url' ? 'trailer-url-error' : (fieldKey === 'season_number' ? 'season-number-error' : (fieldKey === 'meta_title' ? 'meta_title_error' : fieldKey + '-error'));
            ...
            var errs = window.__seasonCreateCurrentErrors || currentErrors || {};
            ...
            if (changed) { currentErrors = errs; window.__seasonCreateCurrentErrors = errs; if (window.showErrorCountOnTabs) window.showErrorCountOnTabs(errs, seasonTabFields); }
        }
