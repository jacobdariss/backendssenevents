...
class SeasonService
{
    ...
    public function getDataTable(Datatables $datatable, array $filter)
    {
        ...
        ->addColumn('approval_col', function ($data) {
            ...
            ->rawColumns(['action', 'status', 'check','poster_url','entertainment_id','partner_name','approval_col'])
            ->toJson();
    }
    ...
    public function getSeasonsList(int $tv_show_id){
     ...
     public function getSeasonsDetails(int $tvshow_id,int $season_id){
     ...
     public function getSeasonVideos(int $tvshow_id,int $season_id){
