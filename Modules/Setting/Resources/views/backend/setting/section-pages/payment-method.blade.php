    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('backend.setting.store') }}" id="form-submit">
            ...
            <div id="razorpay-fields"
                class=" {{ old('razor_payment_method', $settings['razor_payment_method'] ?? 0) == 1 ? '' : 'd-none' }}">
                <div class="row">
                    <div class="col-md-6">
            ...
            <div id="stripe-fields"
                class=" {{ old('str_payment_method', $settings['str_payment_method'] ?? 0) == 1 ? '' : 'd-none' }}">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label"
            ...
            <div id="paystack-fields"
                class=" {{ old('paystack_payment_method', $settings['paystack_payment_method'] ?? 0) == 1 ? '' : 'd-none' }}">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label"
            ...
            <div id="paypal-fields"
                class=" {{ old('paypal_payment_method', $settings['paypal_payment_method'] ?? 0) == 1 ? '' : 'd-none' }}">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label"
            ...
            <div id="flutterwave-fields"
                class=" {{ old('flutterwave_payment_method', $settings['flutterwave_payment_method'] ?? 0) == 1 ? '' : 'd-none' }}">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label"
            ...
            <div id="cinet-fields"
                class=" {{ old('cinet_payment_method', $settings['cinet_payment_method'] ?? 0) == 1 ? '' : 'd-none' }}">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
            ...
            <div id="sadad-fields"
                class=" {{ old('sadad_payment_method', $settings['sadad_payment_method'] ?? 0) == 1 ? '' : 'd-none' }}">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
            ...
            <div id="airtel-money-fields"
                class=" {{ old('airtel_payment_method', $settings['airtel_payment_method'] ?? 0) == 1 ? '' : 'd-none' }}">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label"
            ...
            <div id="phonepe-fields"
                class=" {{ old('phonepe_payment_method', $settings['phonepe_payment_method'] ?? 0) == 1 ? '' : 'd-none' }}">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label"
            ...
            <div class="form-group border-bottom pb-3">
                <div class="d-flex justify-content-between align-items-center">
                    <label class="form-label m-0" for="payment_method_wave">{{ __('setting_payment_method.lbl_wave') }}</label>
            ...
            <div id="wave-fields"
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label" for="wave_api_key">{{ __('setting_payment_method.lbl_secret_key') }}</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label" for="wave_base_url">{{ __('setting_payment_method.lbl_base_url') }}</label>
            ...
            <div id="midtrans-fields"
                class=" {{ old('midtrans_payment_method', $settings['midtrans_payment_method'] ?? 0) == 1 ? '' : 'd-none' }}">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label"
            ...
            <div id="iap-fields"    
                class=" {{ old('iap_payment_method', $settings['iap_payment_method'] ?? 0) == 1 ? '' : 'd-none' }}">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label"
