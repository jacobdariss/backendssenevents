        ...
        <div class="card">
            <div class="card-body">
                <div class="list-group list-group-flush" id="setting-list">
                    @if(auth()->user()->hasAnyRole(['admin', 'super_admin', 'superadmin', 'demo_admin']) || auth()->user()->can('setting_bussiness'))
                    ...
                    @endif
                    @if(auth()->user()->hasAnyRole(['admin', 'super_admin', 'superadmin', 'demo_admin']) || auth()->user()->can('setting_custom_code'))
                        <div class="mb-3 active-menu">
                    ...
                    @endif
                    @if(auth()->user()->hasAnyRole(['admin', 'super_admin', 'superadmin', 'demo_admin']) || auth()->user()->can('setting_module'))
                    <div class="mb-3 active-menu">
                    ...
                    @endif
                    @if(auth()->user()->hasAnyRole(['admin', 'super_admin', 'superadmin', 'demo_admin']) || auth()->user()->can('setting_misc'))
                        <div class="mb-3 active-menu">
                    ...
                    @endif
                    @if(auth()->user()->hasAnyRole(['admin', 'super_admin', 'superadmin', 'demo_admin']) || auth()->user()->can('setting_customization'))
                        <div class="mb-3 active-menu">
                    ...
                    @endif
                    @if(auth()->user()->hasAnyRole(['admin', 'super_admin', 'superadmin', 'demo_admin']) || auth()->user()->can('setting_mail'))
                        <div class="mb-3 active-menu">
                    ...
                    @endif
                    @if(auth()->user()->hasAnyRole(['admin', 'super_admin', 'superadmin', 'demo_admin']) || auth()->user()->can('setting_notification'))
                        <div class="mb-3 active-menu">
                    ...
                    @endif
                    @if(auth()->user()->hasAnyRole(['admin', 'super_admin', 'superadmin', 'demo_admin']) || auth()->user()->can('setting_language'))
                        <div class="mb-3 active-menu">
                    ...
                    @if(auth()->user()->hasAnyRole(['admin', 'super_admin', 'superadmin', 'demo_admin']) || auth()->user()->can('view_currency'))
                    <div class="mb-3 active-menu">
