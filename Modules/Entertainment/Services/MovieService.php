...
class MovieService
{
    ...
    public function __construct(MovieRepositoryInterface $movieRepository)
    {
        ...
        private function getMovieDetail(int $id)
        {
        ...
        private function getMovieVideoDetail(int $id)
        {
        ...
        private function getCastCrewDetail(int $id)
        {
        ...
        private function formatMovieData( int $tmdb_id,array $movieDetail, array $movieVideoDetail, array $castcrewDetail, array $configurationData)
        {
        ...
        private function processCast(int $tmdb_id,array $castData, array $configurationData, string $department, string $type)
        {
            $result = [];
            $count = 0;
            $maxCount = 5;
        ...
        private function getCrewDetail(int $id)
        {
        ...
        private function processVideoData(array $movieVideoDetail)
        {
        ...
        private function formatDuration(int $minutes)
        {
