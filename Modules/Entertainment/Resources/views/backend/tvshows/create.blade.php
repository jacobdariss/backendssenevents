                        ...
                        <div class="col-md-8 col-lg-6">
                            <div class="d-flex align-items-center gap-2 mb-2 flex-wrap">
                                <a class="ph ph-info" data-bs-toggle="tooltip"
                                    title="{{ __('messages.tooltip_tvshow_id') }}"
                                    href="https://www.themoviedb.org/tv/63174-lucifer" target="_blank"></a>
                                {{ html()->label(__('movie.import_tvshow'))->class('form-label') }}
                            </div>
                    ...
                    <div class="row gy-3">
                        ...
                        <div class="row gy-3">
                            ...
                            <div class="col-md-4 col-lg-4 d-none" id="embed_input">
                                {{ html()->label(__('movie.lbl_embed_code') . ' <span class="text-danger">*</span>', 'trailer_url_embedded')->class('form-label form-label') }}
                ...
                <div class="card-body">
                    <div class="row gy-3">
                        ...
                        <div class="col-md-6 col-lg-4">
                            ...
                            {{ html()->select('genres[]', $genres->pluck('name', 'id')->prepend(__('placeholder.lbl_select_genres'), ''), old('genres'))->class('form-control select2')->id('genres')->multiple()->attribute('required', 'required') }}
                            @error('genres')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="col-md-6 col-lg-4">
                            ...
                            {{ html()->select('countries[]', $countries->pluck('name', 'id')->prepend(__('placeholder.lbl_select_countries'), ''), old('countries'))->class('form-control select2')->id('countries')->multiple() }}
                            @error('countries')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            {{ html()->select('actors[]', $actors->pluck('name', 'id')->prepend(__('placeholder.lbl_select_actors'), ''), old('actors'))->class('form-control select2')->id('actors')->multiple()->attribute('required', 'required') }}
                            @error('actors')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="col-md-6">
                            ...
                            {{ html()->select('directors[]', $directors->pluck('name', 'id')->prepend(__('placeholder.lbl_select_directors'), ''), old('directors'))->class('form-control select2')->id('directors')->multiple()->attribute('required', 'required') }}
                            @error('directors')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
...
@push('after-scripts')
    ...
    <script>
            ...
            setup: function(editor) {
                const syncDescriptionErrors = function() {
                    ...
                    if (!textContent) {
                        ...
                        $error.hide();
                        try {
                            const errs = window.__tvshowCreateCurrentErrors || {};
                            if (errs.description) delete errs.description;
                            Object.keys(errs).forEach(function(k) {
                                if (k === 'description' || (k && k.startsWith('description.'))) delete errs[k];
                            });
                            window.__tvshowCreateCurrentErrors = errs;
                            if (window.showErrorCountOnTabs && window.__tvshowCreateTabFields) {
                                window.showErrorCountOnTabs(errs, window.__tvshowCreateTabFields);
                            }
                        } catch (e) {}
                    }
                };
        ...
        let currentErrors = {};
        window.__tvshowCreateCurrentErrors = currentErrors;
        window.__tvshowCreateTabFields = tvshowTabFields;
        ...
        function clearFieldValidation(el) {
            ...
            var errs = window.__tvshowCreateCurrentErrors || currentErrors || {};
