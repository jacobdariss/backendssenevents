...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (!Schema::hasColumn('partners', 'commission_rate')) { Schema::table('partners', function (Blueprint $table) {
        ...
        if (!Schema::hasColumn('videos', 'partner_proposed_price')) { Schema::table('videos', function (Blueprint $table) {
