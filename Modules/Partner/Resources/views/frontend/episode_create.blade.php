...
<div class="card mb-3">
    <div class="card-header">
        <h5 class="mb-0"><i class="ph ph-film-strip me-2"></i>{{ __('partner::partner.add_episode') }}
            ...
            <div class="col-md-6">
                ...
                <div class="d-flex flex-wrap align-items-center gap-3">
                    <label class="form-check form-check-inline form-control cursor-pointer w-auto m-0"><div>
                        <input class="form-check-input" type="radio" name="access" value="free" onchange="togglePpvFields(this.value)" {{ old('access','free')=='free'?'checked':'' }}>
                        <span class="form-check-label">{{ __('movie.lbl_free') }}</span>
                    </div></label>
                    <label class="form-check form-check-inline form-control cursor-pointer w-auto m-0"><div>
                        <input class="form-check-input" type="radio" name="access" value="pay-per-view" onchange="togglePpvFields(this.value)" {{ old('access')=='pay-per-view'?'checked':'' }}>
            ...
            <div class="col-12"><div class="row g-3">
                ...
                <div class="col-md-8">
                    ...
                    <div class="d-none" id="trailer_url_section">
                        ...
                        {{ html()->text('trailer_url',old('trailer_url'))->class('form-control')->id('trailer_url')->placeholder('https://...') }}
                    </div>
