...
@section('title') {{ __('partner::partner.register_title') }} @endsection
                    ...
                    <div class="user-login-card card my-5">
                        <div class="auth-heading">
                            <div class="text-center mb-4">
                                ...
                                <h5>{{ __('partner::partner.register_title') }}</h5>
                                <p class="text-muted small">{{ __('partner::partner.register_subtitle') }}</p>
                            </div>
                            ...
                            <form action="{{ route('partner.register.store') }}" method="POST">
                                ...
                                <h6 class="text-muted mb-3 border-bottom pb-2">{{ __('partner::partner.register_section_account') }}</h6>
                                ...
                                <h6 class="text-muted mb-3 border-bottom pb-2">{{ __('partner::partner.register_section_company') }}</h6>

                                <div class="input-group mb-3">
                                    <span class="input-group-text"><i class="ph ph-buildings"></i></span>
                                    <input type="text" name="company_name" class="form-control @error('company_name') is-invalid @enderror"
                                        placeholder="{{ __('partner::partner.lbl_company_name') }}" value="{{ old('company_name') }}" required>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="phone" class="form-control"
                                        placeholder="{{ __('partner::partner.lbl_phone') }}" value="{{ old('phone') }}">
                                </div>

                                <div class="input-group mb-3">
                                    <span class="input-group-text"><i class="ph ph-globe"></i></span>
                                    <input type="url" name="website" class="form-control"
                                        placeholder="{{ __('partner::partner.lbl_website') }}" value="{{ old('website') }}">
                                </div>

                                <div class="mb-4">
                                    <textarea name="description" class="form-control" rows="3"
                                        placeholder="{{ __('partner::partner.placeholder_description') }}">{{ old('description') }}</textarea>
                                </div>

                                <button type="submit" class="btn btn-primary w-100 mb-3">
                                    {{ __('partner::partner.register_submit') }}
                                </button>

                                <p class="text-center small text-muted mb-0">
                                    {{ __('partner::partner.already_have_account') }}
                                    <a href="{{ route('partner.login') }}">{{ __('messages.login') }}</a>
                                </p>
                            </form>
                        </div>
                    </div>
