...
{{ html()->form('POST', route('partner.videos.store'))->attribute('enctype', 'multipart/form-data')->attribute('id', 'form-submit')->open() }}
    ...
    <div class="card mb-3">
        <div class="card-header"><h5 class="mb-0"><i class="ph ph-video me-2"></i>{{ __('partner::partner.add_video') }}</h5></div>
        <div class="card-body">
            <div class="row gy-3">
                ...
                <div class="col-12 {{ old('access') == 'pay-per-view' ? '' : 'd-none' }}" id="ppv_fields">
                    <div class="row g-3">
                        ...
                        <div class="col-md-3">
                            ...
                            {{ html()->select('purchase_type', ['rental' => __('messages.lbl_rental'), 'onetime' => __('messages.lbl_one_time_purchase')], old('purchase_type', 'rental'))->class('form-control select2')->id('purchase_type')->attribute('onchange', 'toggleAccessDurationPartner(this.value)') }}
                        </div>
                ...
                <div class="col-md-6 d-none" id="video_file_input_section">
                    ...
                    <div class="input-group btn-video-link-upload">
                        ...
                        {{ html()->text('video_file_input')->class('form-control')->placeholder('Select file')->attribute('data-bs-toggle', 'modal')->attribute('data-bs-target', '#exampleModal')->attribute('data-image-container', 'selectedImageContainerVideourl')->attribute('data-hidden-input', 'file_url_video') }}
                    </div>
                ...
                <div class="col-md-8">
                    <div id="url_input">
                        ...
                        {{ html()->text('trailer_url', old('trailer_url', ''))->class('form-control')->placeholder(__('placeholder.lbl_trailer_url'))->id('trailer_url') }}
                    </div>
                    <div id="url_file_input" class="d-none">
                        ...
                        <div class="input-group btn-video-link-upload">
                            ...
                            {{ html()->text('trailer_input', old('trailer_url', ''))->class('form-control')->attribute('data-bs-toggle', 'modal')->attribute('data-bs-target', '#exampleModal')->attribute('data-image-container', 'selectedImageContainertailerurl')->attribute('data-hidden-input', 'file_url_trailer') }}
                        </div>
                        <div class="mt-2" id="selectedImageContainertailerurl"></div>
                        {{ html()->hidden('trailer_url')->id('file_url_trailer')->value(old('trailer_url', '')) }}
                    </div>
