    ...
    <div class="card-main mb-5">
        <x-backend.section-header>
            <div class="d-flex flex-wrap gap-3">
                <x-backend.quick-action url='{{ route("backend.partners.bulk_action") }}' :entity_name="__('partner::partner.title')" :entity_name_plural="__('partner::partner.title')">
                    <div class="">
            ...
            <x-slot name="toolbar">
                ...
                <a href="{{ route('backend.partners.create') }}" class="btn btn-primary d-flex align-items-center gap-1" id="add-post-button">
...
@push('after-scripts')
    ...
    <script type="text/javascript" defer>
        const columns = [
            {
                data: 'check',
                name: 'check',
                title: '<input type="checkbox" class="form-check-input" name="select_all_table" id="select-all-table" data-type="partners" onclick="selectAllTable(this)">',
                width: '0%',
                exportable: false,
                orderable: false,
                searchable: false,
            ...
            },
            {
                data: 'email',
                name: 'email',
                title: "{{ __('partner::partner.lbl_email') }}",
            },
            {
                data: 'website',
                name: 'website',
                title: "{{ __('partner::partner.lbl_website') }}",
            },
            {
                data: 'status',
                name: 'status',
        ...
        document.addEventListener('DOMContentLoaded', function () {
            initDatatable({
                url: '{{ route("backend.partners.index_data") }}',
                finalColumns,
                orderColumn: [[5, 'desc']],
                advanceFilter: () => {
                    return {};
