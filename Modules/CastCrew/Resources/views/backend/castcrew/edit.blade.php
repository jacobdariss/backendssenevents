...
@section('content')
    ...
    {{ html()->form('PUT', route('backend.castcrew.update', $cast->id))->attribute('enctype', 'multipart/form-data')->attribute('data-toggle', 'validator')->attribute('id', 'form-submit')->class('requires-validation')->attribute('novalidate', 'novalidate')->open() }}
            ...
            <div class="row gy-3">
                <div class="col-md-6 col-lg-4 position-relative">
                    ...
                    <div class="uploaded-image" id="selectedImageContainer1">
                        @if ($cast->file_url)
                            <img src="{{ $cast->file_url }}" class="img-fluid mb-2"
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="mb-3">
                        ...
                        {{ html()->text('name', $cast->name)->class('form-control')->id('name')->placeholder(__('placeholder.lbl_cast_name'))->attribute('required', 'required') }}
                        @error('name')
                    ...
                    <div>
                        ...
                        {{ html()->text('designation', $cast->designation)->class('form-control')->id('designation')->placeholder(__('placeholder.lbl_cast_designation')) }}
                        @error('designation')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-between align-items-center form-control">
                            ...
                            <div class="form-check form-switch">
                                ...
                                {{ html()->checkbox('status', $cast->status)->class('form-check-input')->id('status')->value(1) }}
                            </div>
                        </div>
                        @error('status')
                            <span class="text-danger">{{ $message }}</span>
