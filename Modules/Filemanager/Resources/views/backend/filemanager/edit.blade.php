...
<div class="card">
  <div class="card-body">
  {{ html()->form('POST' ,route('backend.media-library.update', $data->id))->attribute('enctype', 'multipart/form-data')->attribute('data-toggle', 'validator')->open() }}
        @csrf
        @method('PUT')
        <div class="row">
        ...
        <a href="{{ route('backend.media-library.index') }}" class="btn btn-secondary">Close</a>
