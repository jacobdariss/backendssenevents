...
use Modules\NotificationTemplate\Http\Controllers\Backend\NotificationsController;
...
Route::group(['prefix' => 'app', 'as' => 'backend.', 'middleware' => ['auth','admin']], function () {
    ...
    */
    ...
    Route::group(['prefix' => 'notifications-templates', 'as' => 'notificationtemplates.'], function () {
        ...
        Route::get('fetch-notification-data', [NotificationTemplatesController::class, 'fetchNotificationData'])->name('fetchnotification_data');
        Route::get('get-roles', [NotificationTemplatesController::class, 'getRoles'])->name('get_roles');
    });
    ...
    Route::group(['prefix' => 'notifications', 'as' => 'notifications.'], function () {
        ...
        Route::post('bulk-action', [NotificationsController::class, 'bulk_action'])->name('bulk_action');
